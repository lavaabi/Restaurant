...
;(function ( $, window, document, undefined ) {
    ...
    Plugin.prototype._create = function () {
        ...
        this.element.append('<input type="password" placehoder="new password" class="' + options.inputClass + '" "/>');
        ...
        this.element.append(
            ...
            <li data-criterion="capital" class="valid">Atleast <strong>1 Lowercase</strong> & 1 Uppercase</li> \
            <li data-criterion="number" class="valid">Atleast <strong>1 number</strong></li> \
