...
Class Facebook
{
     ...
     * @return  string
     */
    public function login_url($return_url=null)
    {
        if($return_url=="fblogin")
        {
            $r_url="auth/fb_authenticate/";
        }elseif($return_url=="fbpages"){
            $r_url="integrations/fb_pages/";
        }
       ...
       $access_token = $this->get_access_token();
        ...
        { 
            try
            {
                ...
                $redirect_url = base_url('integrations/fb_pages/?state=' . $state);
                $access_token = $this->helper->getAccessToken($redirect_url);
            }
            catch (FacebookSDKException $e)
            {
