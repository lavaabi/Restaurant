    ...
    */
    ...
    {   valid_session_user();
        if(!empty($_POST['profile_update_address']))
        {
            ...
            $insert_data['mobile']                  = isset($_POST['mobile']) ? $_POST['mobile']: Null;
            $profile_address = $this->Auth_model->_insert('mt_address_book',$insert_data);
            $data['update_address']     = true;
            $data['success_msg']        = 'Successfully updated your address.';
